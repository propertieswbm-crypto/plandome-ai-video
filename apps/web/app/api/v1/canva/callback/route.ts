...
export async function GET(request:Request){
  ...
  }catch(error){return NextResponse.redirect(new URL(`/video-editor?canvaError=${encodeURIComponent(error instanceof Error?error.message:"Canva connection failed.")}`,url.origin))}
}
